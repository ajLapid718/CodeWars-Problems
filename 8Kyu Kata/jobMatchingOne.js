...
function match(candidate, job) {
  if (!candidate.hasOwnProperty("minSalary") || !job.hasOwnProperty("maxSalary")) throw Error;
  let acceptableSalary = candidate.minSalary * 0.90;
  return acceptableSalary <= job.maxSalary;
}
