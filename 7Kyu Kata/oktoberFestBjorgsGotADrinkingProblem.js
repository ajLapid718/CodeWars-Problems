...
function gameOfFives (bavarianBeerBears, scandinavianSchöllers) {
  var fivesOnLeftSide = 0;
  var fivesOnRightSide = 0;
  ...
  for (var j = 0; j < scandinavianSchöllers.length; j++) {
    if (scandinavianSchöllers[j] === 5) {
      fivesOnRightSide += 1;
    }
  }

  if (fivesOnLeftSide === fivesOnRightSide) {
