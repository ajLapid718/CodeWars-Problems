...
If either arr1 or arr2 is empty, you should return an empty arr (empty list in python, empty vector in c++).
...
function findArray(arr1, arr2) {
  ...
  for (let i = 0; i < arr2.length; i++) {
    let currentIdx = arr2[i];
    let targetElement = arr1[currentIdx];
